...
echo -e "${SIGPI_BANNER_COLOR} ##"
echo -e "${SIGPI_BANNER_COLOR} ##   Install <PACKAGE>"
echo -e "${SIGPI_BANNER_COLOR} ##"
...
##### BEGIN SCRIPT DL FROM https://get.docker.com #####
...
##### END SCRIPT DL FROM https://get.docker.com #####

# Set user Pi to use docker
sudo usermod -a -G docker pi
# Show Docker is working )need to run sudo for now. Run as pi takes effect after reboot

...
libswscale-dev libtool libudev1 libusb-1.0-0 libusb-1.0-0-dev libusb-dev libv4l-dev libwxgtk-media3.0-dev libxml2-dev \
libzmq3-dev libglfw3-dev libglew-dev libfftw3-dev libglfw3-dev libglew-dev libsoapysdr-dev libairspyhf-dev libiio-dev libad9361-dev librtaudio-dev libhackrf-dev \
libcdk5-dev 

...
sudo apt-get install -y git cmake build-essential autoconf automake g++ gcc gfortran libtool pkg-config pkg-configgit bison flex ffmpeg pulseaudio swig subversion 
sudo apt-get install -y asciidoc asciidoctor doxygen graphviz gsfonts imagemagick imagemagick-6-common imagemagick-6.q16 intltool netpbmlibtool texinfo xsltproc
...
sudo apt-get install -y libusb-1.0-0-dev libad9361-dev libaio-dev libairspyhf-dev libao-dev libasound2-dev libavahi-client-dev libavahi-client-devg++ libavcodec-dev libavformat-dev libbluetooth-dev \
...
libgsl-dev libgsm1-dev libhackrf-devswig libhamlib-dev libheif1 libi2c-dev libiio-dev libjack-dev libjpeg62-turbo-dev libjpeg9-dev liblog4cpp5-dev \
...
libqt5serialport5-dev libqt5sql5-sqlite libqt5svg5-dev libqt5svg5-devzlib1g-dev libqt5texttospeech5-dev libqt5websockets5-dev libqt5widgets5 libqwt-dev libqwt-qt5-dev \
...
libudev-dev libudev-devlibfltk1.3-dev libusb-dev libv4l-dev libvolk2-dev libwxgtk3.0-dev libwxgtk3.0-gtk3-dev libxcursor-dev libxft-dev libxinerama-dev \
libxml2-dev libxml2-devswig libzmq3-dev libxml2-dev
...
python3-yaml python3-zmq python-numpy python-pyside python-qt4git qml-module-qtlocation qml-module-qtpositioning qml-module-qtquick-controls qml-module-qtquick-controls2 \

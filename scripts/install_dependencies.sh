...
sudo apt-get install -y python3-click python3-click-plugins python3-gi-cairo python3-lxml python3-mako python3-numpy python3-pip python3-pyqt5 python3-pyqt4 python3-scipy python3-sphinx \
